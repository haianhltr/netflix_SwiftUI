        ...
        return ZStack{
            ...
            VStack{
                ...
                ScrollView{
                    ...
                    {
                        Text("Your search did not have any results.").bold().padding(.top,150)
                    }
...
struct PopularList: View {
    ...
    var body: some View {
        VStack{
            HStack {
                Text("Popular Searches").bold().font(.title3).padding(.leading,12)
                Spacer()
            }
            ...
            LazyVStack{
                ForEach(movies, id: \.id) {
                    movie in PopularMovieView(movie: movie, movieDetailToShow: $movieDetailToShow)
                        .frame(height: 75)
                }
            }
        }

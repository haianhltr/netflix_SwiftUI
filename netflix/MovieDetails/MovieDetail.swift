                        ...
                        VStack (spacing : 40) {
                            ...
                            ForEach(0..<(movie.numberOfSeasons ?? 0)) {
                                ...
                                Button(action: {
                                    ...
                                    Text("Season \(season + 1)").foregroundColor(selectedSeason == season + 1 ? .white : .gray)
                                        .bold().font(selectedSeason == season + 1 ? .title : .title2)
                                })
...
//a user-defined data type that has a fixed set of related values.
...
struct MovieInfoSubheadline: View {
    ...
    var body: some View {
        ...
        .foregroundColor(.gray).padding(.vertical,6)
    }
}
